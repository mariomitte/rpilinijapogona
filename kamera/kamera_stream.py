# Kreirano korištenjem picamera dokumentacije,
...
# Telegram API za kameru
telegrambot = telebot.TeleBot(TOKEN_BOT)

# Mogućnosti rada sa kamerom: pokreni i zaustavi video, kreiraj fotografiju
# Preuzeto sa picamera dokumentacije
class CameraNetwork:
    def __init__(self):
        self.camera = None
    ...
    # Pohrani fotografiju u direktorij /media/camera/
    def photo(self):
        ...
        # Posalji korisniku detalje o lokaciji fotografije
